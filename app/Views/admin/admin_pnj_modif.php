...
<h2>Modifier les infos de <?= $name ?> :</h2>
...
<form action="" method="post">
    ...
    <input required type="number" name="attack" min="0" max="50" value="<?=$attack ?>">
    <span class="error"><?php if (!empty($error['attack'])){ echo  $error['attack']; } ?></span><br>
    <input type="submit">
</form>
